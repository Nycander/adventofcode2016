...
This, the documentation explains, provides much more substantial compression capabilities, allowing many-gigabyte
...
public class Day9 {
    public static void main(String... args) throws URISyntaxException, IOException {
        Files.lines(Paths.get(Day9.class.getResource("/inputs/day9.txt").toURI()))
                .map(ExperimentalFile::decompress)
                .map(ExperimentalFile::getLength)
                .forEach(System.out::println);

        Files.lines(Paths.get(Day9.class.getResource("/inputs/day9.txt").toURI()))
                .map(ExperimentalFileV2::decompress)
                .map(ExperimentalFileV2::getLength)
                .forEach(System.out::println);
    }
}
