...
public class Day5 {
    ...
    public static void main(String... args) {
        ...
        System.out.println(new PasswordCracker().getPasswordForDoorOfLength(doorId, 8));
        System.out.println(TimeUnit.NANOSECONDS.toMillis(System.nanoTime() - start) + " ms");

        System.out.println();
        start = System.nanoTime();
        System.out.println(new PasswordCracker().getAdvancedPasswordForDoorOfLength(doorId, 8));
        System.out.println(TimeUnit.NANOSECONDS.toMillis(System.nanoTime() - start) + " ms");
    }
}
